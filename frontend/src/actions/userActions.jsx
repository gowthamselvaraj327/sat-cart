...
export const updateProfile = (userData) => async(dispatch) => {
    try{
        ...
        dispatch(updateProfileFail(e.response.data.message));
    }
}
...
export const getUsers = async(dispatch) => {
    try{
        ...
        dispatch(usersFail(e.response.data.message));
    }
}
...
export const getUser = id => async(dispatch) => {
    try{
        ...
        dispatch(userFail(e.response.data.message));
    }
}
...
export const deleteUser = id => async(dispatch) => {
    try{
        ...
        dispatch(deleteUserFail(e.response.data.message));
    }
}
