                    ...
                    <div className="wrapper my-5"> 
                        <form onSubmit={submitHandler} className="shadow-lg" encType='multipart/form-data'>
                            ...
                            <div className="form-group">
                                ...
                                <select disabled={user._id === authUser._id } style={user._id === authUser._id ? {cursor:"not-allowed"}:null} value={role} onChange={e => setRole(e.target.value)} className="form-control" id="category_field">
